...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="container mb-3">
          <div class="d-flex align-items-center">
            <div class="site-logo mr-auto">
              <a href="index.html">SDN 42 KAMBANG<span class="text-primary"></span></a>
            </div>
            <div class="site-quick-contact d-none d-lg-flex ml-auto ">
              <div class="d-flex site-info align-items-center mr-5">
                <span class="block-icon mr-3"><span class="icon-map-marker text-yellow"></span></span>
                <span>kambang, kecamatan lengayang, kabupaten pesisir selatan <br> sumatera barat</span>
              </div>
    ...
    <div class="ftco-blocks-cover-1">
      ...
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('../../assets/style/images/img_2.jpg')">
        <div class="container">
          <div class="row align-items-center ">

            <div class="col-md-5 mt-5 pt-5">
              <span class="text-cursive h5 text-teal">Selamat datang di website kami.</span>
              <h1 class="mb-3 font-weight-bold text-teal">Penerimaan Peserta Didik Baru</h1>
              <p class="mt-5"><a href="daftarSiswa.php" class="btn btn-info py-4 btn-custom-1">Daftar Sekarang</a></p>
            </div>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <span class="text-cursive h5 text-blue d-block">Our Gallery</span>
    ...
    <div class="site-section py-5 bg-info">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-12 d-flex">
          <h2 class="text-white m-0">Pendaftaran Peserta Didik Baru</h2>
          <a href="daftarSiswa.php" class="btn btn-info btn-custom-1 py-3 px-5 ml-auto">Daftar!</a>
          </div>
        </div>
      </div>
    </div>
