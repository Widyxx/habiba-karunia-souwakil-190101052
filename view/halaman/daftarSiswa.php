          ...
          <div class="sidebar-brand sidebar-brand-sm">
            <a href=""><img src="../../assets/img/avatar/icone.png" alt="LP" width="47px"></a>
              ...
              <li class="nav-item dropdown active">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i><span>Data Peserta Didik</span></a>
...
<!-- Footer -->
      ...
      <footer class="main-footer">
        <div class="footer-left">
        	Copyright &copy; 2022 <div class="bullet"></div> Design By <a href="">Framework id</a>
        </div>
        <div class="footer-right">
        	Developer : <a href="" target="blank">Framework id</a> 
        </div>
      </footer>
    </div>
  </div>
